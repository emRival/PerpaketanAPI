<div class="modal fade" id="modal-del-selesai{{$row->id}}" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-danger modal-dialog-centered modal-" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('selesai.destroy', $row->id) }}" method="POST">
                @csrf
                @method('DELETE')
                <div class="modal-body">
                    <div class="text-center">
                        ...
                        <p>Apakah Anda Yakin Akan Menghapus Data Barang <br><strong>{{$row->nama_penerima}}
                                ?</strong>
